...
typedef enum mip_shared_gps_timestamp_data_valid_flags mip_shared_gps_timestamp_data_valid_flags;
...
typedef enum mip_shared_external_timestamp_data_valid_flags mip_shared_external_timestamp_data_valid_flags;
...
typedef enum mip_shared_external_time_delta_data_valid_flags mip_shared_external_time_delta_data_valid_flags;
