...
UNIT_TEST("Formatting", "A packet can be properly formatted to bytes")
{
    char buffer[128];
    size_t index = 0;
...
UNIT_TEST("Formatting", "A packet can be properly formatted to a human-readable string")
{
    char buffer[128];
    size_t index = 0;
...
UNIT_TEST("Formatting", "A field can be properly formatted to a human-readable string")
{
    char buffer[128];
    size_t index = 0;
