...
function(microstrain_discover_tests_c)
    ...
    set(MAIN_CONTENT "${MAIN_CONTENT}// Generated by discover_tests.cmake\n\n")
    ...
    foreach(TEST_NAME ${DISCOVERED_TESTS})
        set(MAIN_CONTENT "${MAIN_CONTENT}MICROSTRAIN_TEST_CASE(${TEST_NAME});\n")
    endforeach()
    ...
    set(MAIN_CONTENT "${MAIN_CONTENT}    const char* test_filter = nullptr;\n")
    set(MAIN_CONTENT "${MAIN_CONTENT}    \n")
    ...
    set(MAIN_CONTENT "${MAIN_CONTENT}    \n")
    set(MAIN_CONTENT "${MAIN_CONTENT}    return TEST_FRAMEWORK_END();\n")
    set(MAIN_CONTENT "${MAIN_CONTENT}}\n")
