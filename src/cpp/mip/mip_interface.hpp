...
namespace mip
{
    ...
    CmdResult runCommand(C::mip_interface& device, const Cmd& cmd, typename Cmd::Response& response, Timeout additionalTime)
    {
        ...
        C::mip_pending_cmd pending;
        C::mip_pending_cmd_init_full(&pending, Cmd::DESCRIPTOR_SET, Cmd::FIELD_DESCRIPTOR, Cmd::Response::FIELD_DESCRIPTOR, packet.bufferPointer(), FIELD_PAYLOAD_LENGTH_MAX, additionalTime);
        ...
        return extract(response, {packet.buffer().data(), responseLength}, 0) ? CmdResult::ACK_OK : CmdResult::STATUS_ERROR;
    }
