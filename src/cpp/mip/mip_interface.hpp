...
namespace mip
{
    ...
    public:
        ...
        bool sendToDevice(const C::mip_packet_view& packet) { return sendToDevice(C::mip_packet_data_pointer(&packet), C::mip_packet_total_length(&packet)); }
    ...
    CmdResult runCommand(C::mip_interface& device, const Cmd& cmd, typename Cmd::Response& response, Timeout additionalTime)
    {
        ...
        C::mip_pending_cmd pending;
        C::mip_pending_cmd_init_full(&pending, Cmd::DESCRIPTOR_SET, Cmd::FIELD_DESCRIPTOR, Cmd::Response::FIELD_DESCRIPTOR, packet.bufferPtr_w(), FIELD_PAYLOAD_LENGTH_MAX, additionalTime);
        ...
        return extract(response, packet.bufferPtr(), responseLength, 0) ? CmdResult::ACK_OK : CmdResult::STATUS_ERROR;
    }
