...
struct MetadataFor<commands_filter::EstimationControl::EnableFlags>
{
    ...
    static constexpr inline BitfieldInfo::Entry entries[] = {
        ...
        { 2, "accel_bias", "" },
        { 4, "gyro_scale_factor", "" },
        { 8, "accel_scale_factor", "" },
        { 16, "antenna_offset", "" },
        { 32, "auto_mag_hard_iron", "" },
        { 64, "auto_mag_soft_iron", "" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            /* .name          = */ "enable",
            /* .docs          = */ "See above",
            /* .type          = */ {Type::BITFIELD, &MetadataFor<commands_filter::EstimationControl::EnableFlags>::value},
            /* .accessor      = */ utils::access<type, commands_filter::EstimationControl::EnableFlags, &type::enable>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, double, &type::gps_time>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .accessor      = */ utils::access<type, uint16_t, &type::gps_week>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::ExternalHeadingUpdate>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::heading_uncertainty>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            /* .name          = */ "axes",
            /* .docs          = */ "Axes to tare",
            /* .type          = */ {Type::BITFIELD, &MetadataFor<commands_filter::TareOrientation::MipTareAxes>::value},
            /* .accessor      = */ utils::access<type, commands_filter::TareOrientation::MipTareAxes, &type::axes>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::VehicleDynamicsMode::DynamicsMode, &type::mode>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, Quatf, &type::quat>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::GnssSource::Source>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 1, "ALL_INT", "All internal receivers" },
        { 2, "EXT", "External GNSS messages provided by user" },
        { 3, "INT_1", "Internal GNSS Receiver 1 only" },
        { 4, "INT_2", "Internal GNSS Receiver 2 only" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::GnssSource::Source, &type::source>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::HeadingSource::Source>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "NONE", "See note 3" },
        { 1, "MAG", "" },
        { 2, "GNSS_VEL", "See notes 1,2" },
        { 3, "EXTERNAL", "" },
        { 4, "GNSS_VEL_AND_MAG", "" },
        { 5, "GNSS_VEL_AND_EXTERNAL", "" },
        { 6, "MAG_AND_EXTERNAL", "" },
        { 7, "GNSS_VEL_AND_MAG_AND_EXTERNAL", "" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::HeadingSource::Source, &type::source>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::noise>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::beta>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::AltitudeAiding::AidingSelector>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "NONE", "No altitude aiding" },
        { 1, "PRESURE", "Enable pressure sensor aiding" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::AltitudeAiding::AidingSelector, &type::selector>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::PitchRollAiding::AidingSource>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "NONE", "No pitch/roll aiding" },
        { 1, "GRAVITY_VEC", "Enable gravity vector aiding" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::PitchRollAiding::AidingSource, &type::source>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::AutoZupt::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .docs          = */ "[meters/second]",
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::threshold>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::noise>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Matrix3f>::value},
            /* .accessor      = */ utils::access<type, Matrix3f, &type::noise>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::FilterMagParamSource>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 1, "NONE", "No source. See command documentation for default behavior" },
        { 2, "WMM", "Magnetic field is assumed to conform to the World Magnetic Model, calculated using current location estimate as an input to the model." },
        { 3, "MANUAL", "Magnetic field is assumed to have the parameter specified by the user." },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::FilterMagParamSource, &type::source>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::ReferencePosition::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .docs          = */ "[meters]",
            /* .type          = */ {Type::DOUBLE, nullptr},
            /* .accessor      = */ utils::access<type, double, &type::altitude>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::FilterAdaptiveMeasurement>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "DISABLED", "No adaptive measurement" },
        { 1, "FIXED", "Enable fixed adaptive measurement (use specified limits)" },
        { 2, "AUTO", "Enable auto adaptive measurement" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::FilterAdaptiveMeasurement, &type::adaptive_measurement>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        ...
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::low_limit>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .docs          = */ "[meters/second^2]",
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::high_limit>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::low_limit_uncertainty>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .docs          = */ "1-Sigma [meters/second^2]",
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::high_limit_uncertainty>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .docs          = */ "1-Sigma [meters/second^2]",
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::minimum_uncertainty>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::AidingMeasurementEnable::AidingSource>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "GNSS_POS_VEL", "GNSS Position and Velocity" },
        { 1, "GNSS_HEADING", "GNSS Heading (dual antenna)" },
        { 2, "ALTIMETER", "Pressure altimeter (built-in sensor)" },
        { 3, "SPEED", "Speed sensor / Odometer" },
        { 4, "MAGNETOMETER", "Magnetometer (built-in sensor)" },
        { 5, "EXTERNAL_HEADING", "External heading input" },
        { 6, "EXTERNAL_ALTIMETER", "External pressure altimeter input" },
        { 7, "EXTERNAL_MAGNETOMETER", "External magnetomer input" },
        { 8, "VEHICLE_FRAME_VEL", "External vehicle frame velocity input" },
        { 65535, "ALL", "Save/load/reset all options" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::AidingMeasurementEnable::AidingSource, &type::aiding_source>,
            /* .functions     = */ {true, true, true, true, true,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::FilterReferenceFrame>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 1, "ECEF", "WGS84 Earth-fixed, earth centered coordinates" },
        { 2, "LLH", "WGS84 Latitude, longitude, and height above ellipsoid" },
    };
...
struct MetadataFor<commands_filter::InitializationConfiguration::AlignmentSelector>
{
    ...
    static constexpr inline BitfieldInfo::Entry entries[] = {
        { 1, "dual_antenna", "Dual-antenna GNSS alignment" },
        { 2, "kinematic", "GNSS kinematic alignment (GNSS velocity determines initial heading)" },
        { 4, "magnetometer", "Magnetometer heading alignment (Internal magnetometer determines initial heading)" },
        { 8, "external", "External heading alignment (External heading input determines heading)" },
    };
...
struct MetadataFor<commands_filter::InitializationConfiguration::InitialConditionSource>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 0, "AUTO_POS_VEL_ATT", "Automatic position, velocity and attitude" },
        { 1, "AUTO_POS_VEL_PITCH_ROLL", "Automatic position and velocity, automatic pitch and roll, and user-specified heading" },
        { 2, "AUTO_POS_VEL", "Automatic position and velocity, with fully user-specified attitude" },
        { 3, "MANUAL", "User-specified position, velocity, and attitude." },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .type          = */ {Type::U8, nullptr},
            /* .accessor      = */ utils::access<type, uint8_t, &type::wait_for_run_command>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::InitializationConfiguration::InitialConditionSource, &type::initial_cond_src>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::BITFIELD, &MetadataFor<commands_filter::InitializationConfiguration::AlignmentSelector>::value},
            /* .accessor      = */ utils::access<type, commands_filter::InitializationConfiguration::AlignmentSelector, &type::auto_heading_alignment_selector>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::initial_heading>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::initial_pitch>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::initial_roll>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::initial_position>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::initial_velocity>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::FilterReferenceFrame, &type::reference_frame_selector>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::AdaptiveFilterOptions::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .type          = */ {Type::U16, nullptr},
            /* .accessor      = */ utils::access<type, uint16_t, &type::time_limit>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::MultiAntennaOffset::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .docs          = */ "",
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::antenna_offset>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::RelPosConfiguration::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .accessor      = */ utils::access<type, Vector3d, &type::reference_coordinates>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::RefPointLeverArm::ReferencePointSelector>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        { 1, "VEH", "Defines the origin of the vehicle" },
    };
    ...
    static constexpr inline ParameterInfo parameters[] = {
        {
            ...
            /* .accessor      = */ utils::access<type, commands_filter::RefPointLeverArm::ReferencePointSelector, &type::ref_point_sel>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
        {
            ...
            /* .type          = */ {Type::STRUCT, &MetadataFor<Vector3f>::value},
            /* .accessor      = */ utils::access<type, Vector3f, &type::lever_arm_offset>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::SpeedMeasurement>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::speed_uncertainty>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
...
struct MetadataFor<commands_filter::GnssAntennaCalControl::Response>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .type          = */ {Type::FLOAT, nullptr},
            /* .accessor      = */ utils::access<type, float, &type::max_offset>,
            /* .functions     = */ {true, false, false, false, false,  true},
            /* .count         = */ 1,
            /* .condition     = */ {},
        },
