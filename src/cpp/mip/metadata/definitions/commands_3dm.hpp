...
struct MetadataFor<commands_3dm::NmeaMessage::MessageID>
{
    ...
    static constexpr inline EnumInfo::Entry entries[] = {
        ...
        { 129, "MSRA", "MicroStrain proprietary Euler angles. Source must be the Filter dataset. The talker ID must be set to IGNORED." },
        { 130, "MSRR", "MicroStrain proprietary Angular Rate/Acceleration. Source must be the Sensor dataset. The talker ID must be set to IGNORED." },
    };
...
struct MetadataFor<commands_3dm::EventTrigger::ThresholdParams>
{
    ...
    static constexpr inline ParameterInfo parameters[] = {
        ...
        },
        {
            ...
            /* .docs          = */ "",
            /* .type          = */ {Type::DOUBLE, nullptr},
            /* .accessor      = */ utils::access<type, double, &type::low_thres>,
            /* .functions     = */ NO_FUNCTIONS,
            /* .count         = */ 1,
        ...
        },
        {
            ...
            /* .docs          = */ "",
            /* .type          = */ {Type::DOUBLE, nullptr},
            /* .accessor      = */ utils::access<type, double, &type::int_thres>,
            /* .functions     = */ NO_FUNCTIONS,
            /* .count         = */ 1,
        ...
        },
        {
            ...
            /* .docs          = */ "",
            /* .type          = */ {Type::DOUBLE, nullptr},
            /* .accessor      = */ utils::access<type, double, &type::high_thres>,
            /* .functions     = */ NO_FUNCTIONS,
            /* .count         = */ 1,
            /* .condition     = */ {ParameterInfo::Condition::Type::ENUM, microstrain::Index(3) /* type */, static_cast<uint16_t>(commands_3dm::EventTrigger::ThresholdParams::Type::WINDOW)} /* type == WINDOW */,
        },
        {
            ...
            /* .docs          = */ "",
            /* .type          = */ {Type::DOUBLE, nullptr},
            /* .accessor      = */ utils::access<type, double, &type::interval>,
            /* .functions     = */ NO_FUNCTIONS,
            /* .count         = */ 1,
            /* .condition     = */ {ParameterInfo::Condition::Type::ENUM, microstrain::Index(3) /* type */, static_cast<uint16_t>(commands_3dm::EventTrigger::ThresholdParams::Type::INTERVAL)} /* type == INTERVAL */,
        },
...
static constexpr inline const DescriptorSet COMMANDS_3DM_DS(commands_3dm::DESCRIPTOR_SET, "commands_3dm", COMMANDS_3DM_FIELDS);
