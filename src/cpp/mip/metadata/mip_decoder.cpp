...
void FieldByteFormatter::formatPacket(const PacketView& packet, const Definitions& mipdefs)
{
    const DescriptorSet* info = mipdefs.findDescriptorSet(packet.descriptorSet());
...
void FieldByteFormatter::formatField(const mip::FieldView &field, const Definitions &mipdefs)
{
...
void FieldByteFormatter::formatField(const FieldInfo* info, const FieldView& field)
{
...
void FieldByteFormatter::formatStruct(const StructInfo* info, size_t offset_index)
{
...
void FieldByteFormatter::formatStructContents(const StructInfo* info, size_t offset_index)
{
    assert(info);
...
void FieldByteFormatter::formatUnion(const UnionInfo* info, const StructInfo& parent, size_t offset_index)
{
...
void FieldByteFormatter::formatParameter(const ParameterInfo& param, const StructInfo& parent, size_t offset_index)
{
