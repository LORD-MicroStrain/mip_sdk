...
namespace mip
{
    ...
    public:
        ...
        ///
        TimestampManager(const mip::TimeStandard &standard);
        ...
        TimestampManager(const mip::TimeStandard &standard, DurationIn time);
        ...
        /// @endcode
        ///
        void increment(const TimestampManager &reference_new, const TimestampManager &reference_old);
        ...
        bool timeElapsed(const TimestampManager &reference);
        ...
        bool timeChanged(const TimestampManager &reference) const;
        ...
        void setTimestamp(const TimestampManager &from);
    ...
    template<class DurationIn>
    inline TimestampManager::TimestampManager(const mip::TimeStandard &standard, DurationIn time) :
        m_standard(standard)
    {
    ...
    inline bool TimestampManager::timeElapsed(const TimestampManager &reference)
    {
    ...
    inline bool TimestampManager::timeChanged(const TimestampManager &reference) const
    {
        const Nanoseconds m_reference = reference.getTimestamp();
        if (m_timestamp < m_reference)
        {
    ...
    template<typename DurationIn>
    inline void TimestampManager::setTimestamp(DurationIn time)
    {
        setTimestamp(std::chrono::duration_cast<Nanoseconds>(time));
    }

    template<typename DurationIn>
    inline void TimestampManager::setTimeOfWeek(DurationIn time)
    {
        setTimeOfWeek(std::chrono::duration_cast<Nanoseconds>(time));
    }

    template<typename DurationOut>
    inline DurationOut TimestampManager::getTimestamp() const
    {
        return std::chrono::duration_cast<DurationOut>(getTimestamp());
    }

    template<typename DurationOut>
    inline DurationOut TimestampManager::getTimeOfWeek() const
    {
