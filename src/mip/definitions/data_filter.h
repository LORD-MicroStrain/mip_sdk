...
void insert_mip_filter_position_llh_data(struct microstrain_serializer* serializer, const mip_filter_position_llh_data* self);
void extract_mip_filter_position_llh_data(struct microstrain_serializer* serializer, mip_filter_position_llh_data* self);
...
void insert_mip_filter_velocity_ned_data(struct microstrain_serializer* serializer, const mip_filter_velocity_ned_data* self);
void extract_mip_filter_velocity_ned_data(struct microstrain_serializer* serializer, mip_filter_velocity_ned_data* self);
...
void insert_mip_filter_attitude_quaternion_data(struct microstrain_serializer* serializer, const mip_filter_attitude_quaternion_data* self);
void extract_mip_filter_attitude_quaternion_data(struct microstrain_serializer* serializer, mip_filter_attitude_quaternion_data* self);
...
void insert_mip_filter_attitude_dcm_data(struct microstrain_serializer* serializer, const mip_filter_attitude_dcm_data* self);
void extract_mip_filter_attitude_dcm_data(struct microstrain_serializer* serializer, mip_filter_attitude_dcm_data* self);
...
void insert_mip_filter_euler_angles_data(struct microstrain_serializer* serializer, const mip_filter_euler_angles_data* self);
void extract_mip_filter_euler_angles_data(struct microstrain_serializer* serializer, mip_filter_euler_angles_data* self);
...
void insert_mip_filter_gyro_bias_data(struct microstrain_serializer* serializer, const mip_filter_gyro_bias_data* self);
void extract_mip_filter_gyro_bias_data(struct microstrain_serializer* serializer, mip_filter_gyro_bias_data* self);
...
void insert_mip_filter_accel_bias_data(struct microstrain_serializer* serializer, const mip_filter_accel_bias_data* self);
void extract_mip_filter_accel_bias_data(struct microstrain_serializer* serializer, mip_filter_accel_bias_data* self);
...
void insert_mip_filter_position_llh_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_position_llh_uncertainty_data* self);
void extract_mip_filter_position_llh_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_position_llh_uncertainty_data* self);
...
void insert_mip_filter_velocity_ned_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_velocity_ned_uncertainty_data* self);
void extract_mip_filter_velocity_ned_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_velocity_ned_uncertainty_data* self);
...
void insert_mip_filter_euler_angles_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_euler_angles_uncertainty_data* self);
void extract_mip_filter_euler_angles_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_euler_angles_uncertainty_data* self);
...
void insert_mip_filter_gyro_bias_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_gyro_bias_uncertainty_data* self);
void extract_mip_filter_gyro_bias_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_gyro_bias_uncertainty_data* self);
...
void insert_mip_filter_accel_bias_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_accel_bias_uncertainty_data* self);
void extract_mip_filter_accel_bias_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_accel_bias_uncertainty_data* self);
...
void insert_mip_filter_timestamp_data(struct microstrain_serializer* serializer, const mip_filter_timestamp_data* self);
void extract_mip_filter_timestamp_data(struct microstrain_serializer* serializer, mip_filter_timestamp_data* self);
...
void insert_mip_filter_status_data(struct microstrain_serializer* serializer, const mip_filter_status_data* self);
void extract_mip_filter_status_data(struct microstrain_serializer* serializer, mip_filter_status_data* self);
...
void insert_mip_filter_linear_accel_data(struct microstrain_serializer* serializer, const mip_filter_linear_accel_data* self);
void extract_mip_filter_linear_accel_data(struct microstrain_serializer* serializer, mip_filter_linear_accel_data* self);
...
void insert_mip_filter_gravity_vector_data(struct microstrain_serializer* serializer, const mip_filter_gravity_vector_data* self);
void extract_mip_filter_gravity_vector_data(struct microstrain_serializer* serializer, mip_filter_gravity_vector_data* self);
...
void insert_mip_filter_comp_accel_data(struct microstrain_serializer* serializer, const mip_filter_comp_accel_data* self);
void extract_mip_filter_comp_accel_data(struct microstrain_serializer* serializer, mip_filter_comp_accel_data* self);
...
void insert_mip_filter_comp_angular_rate_data(struct microstrain_serializer* serializer, const mip_filter_comp_angular_rate_data* self);
void extract_mip_filter_comp_angular_rate_data(struct microstrain_serializer* serializer, mip_filter_comp_angular_rate_data* self);
...
void insert_mip_filter_quaternion_attitude_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_quaternion_attitude_uncertainty_data* self);
void extract_mip_filter_quaternion_attitude_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_quaternion_attitude_uncertainty_data* self);
...
void insert_mip_filter_wgs84_gravity_mag_data(struct microstrain_serializer* serializer, const mip_filter_wgs84_gravity_mag_data* self);
void extract_mip_filter_wgs84_gravity_mag_data(struct microstrain_serializer* serializer, mip_filter_wgs84_gravity_mag_data* self);
...
void insert_mip_filter_heading_update_state_data(struct microstrain_serializer* serializer, const mip_filter_heading_update_state_data* self);
void extract_mip_filter_heading_update_state_data(struct microstrain_serializer* serializer, mip_filter_heading_update_state_data* self);
...
void insert_mip_filter_magnetic_model_data(struct microstrain_serializer* serializer, const mip_filter_magnetic_model_data* self);
void extract_mip_filter_magnetic_model_data(struct microstrain_serializer* serializer, mip_filter_magnetic_model_data* self);
...
void insert_mip_filter_accel_scale_factor_data(struct microstrain_serializer* serializer, const mip_filter_accel_scale_factor_data* self);
void extract_mip_filter_accel_scale_factor_data(struct microstrain_serializer* serializer, mip_filter_accel_scale_factor_data* self);
...
void insert_mip_filter_accel_scale_factor_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_accel_scale_factor_uncertainty_data* self);
void extract_mip_filter_accel_scale_factor_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_accel_scale_factor_uncertainty_data* self);
...
void insert_mip_filter_gyro_scale_factor_data(struct microstrain_serializer* serializer, const mip_filter_gyro_scale_factor_data* self);
void extract_mip_filter_gyro_scale_factor_data(struct microstrain_serializer* serializer, mip_filter_gyro_scale_factor_data* self);
...
void insert_mip_filter_gyro_scale_factor_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_gyro_scale_factor_uncertainty_data* self);
void extract_mip_filter_gyro_scale_factor_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_gyro_scale_factor_uncertainty_data* self);
...
void insert_mip_filter_mag_bias_data(struct microstrain_serializer* serializer, const mip_filter_mag_bias_data* self);
void extract_mip_filter_mag_bias_data(struct microstrain_serializer* serializer, mip_filter_mag_bias_data* self);
...
void insert_mip_filter_mag_bias_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_mag_bias_uncertainty_data* self);
void extract_mip_filter_mag_bias_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_mag_bias_uncertainty_data* self);
...
void insert_mip_filter_standard_atmosphere_data(struct microstrain_serializer* serializer, const mip_filter_standard_atmosphere_data* self);
void extract_mip_filter_standard_atmosphere_data(struct microstrain_serializer* serializer, mip_filter_standard_atmosphere_data* self);
...
void insert_mip_filter_pressure_altitude_data(struct microstrain_serializer* serializer, const mip_filter_pressure_altitude_data* self);
void extract_mip_filter_pressure_altitude_data(struct microstrain_serializer* serializer, mip_filter_pressure_altitude_data* self);
...
void insert_mip_filter_density_altitude_data(struct microstrain_serializer* serializer, const mip_filter_density_altitude_data* self);
void extract_mip_filter_density_altitude_data(struct microstrain_serializer* serializer, mip_filter_density_altitude_data* self);
...
void insert_mip_filter_antenna_offset_correction_data(struct microstrain_serializer* serializer, const mip_filter_antenna_offset_correction_data* self);
void extract_mip_filter_antenna_offset_correction_data(struct microstrain_serializer* serializer, mip_filter_antenna_offset_correction_data* self);
...
void insert_mip_filter_antenna_offset_correction_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_antenna_offset_correction_uncertainty_data* self);
void extract_mip_filter_antenna_offset_correction_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_antenna_offset_correction_uncertainty_data* self);
...
void insert_mip_filter_multi_antenna_offset_correction_data(struct microstrain_serializer* serializer, const mip_filter_multi_antenna_offset_correction_data* self);
void extract_mip_filter_multi_antenna_offset_correction_data(struct microstrain_serializer* serializer, mip_filter_multi_antenna_offset_correction_data* self);
...
void insert_mip_filter_multi_antenna_offset_correction_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_multi_antenna_offset_correction_uncertainty_data* self);
void extract_mip_filter_multi_antenna_offset_correction_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_multi_antenna_offset_correction_uncertainty_data* self);
...
void insert_mip_filter_magnetometer_offset_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_offset_data* self);
void extract_mip_filter_magnetometer_offset_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_offset_data* self);
...
void insert_mip_filter_magnetometer_matrix_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_matrix_data* self);
void extract_mip_filter_magnetometer_matrix_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_matrix_data* self);
...
void insert_mip_filter_magnetometer_offset_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_offset_uncertainty_data* self);
void extract_mip_filter_magnetometer_offset_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_offset_uncertainty_data* self);
...
void insert_mip_filter_magnetometer_matrix_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_matrix_uncertainty_data* self);
void extract_mip_filter_magnetometer_matrix_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_matrix_uncertainty_data* self);
...
void insert_mip_filter_magnetometer_covariance_matrix_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_covariance_matrix_data* self);
void extract_mip_filter_magnetometer_covariance_matrix_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_covariance_matrix_data* self);
...
void insert_mip_filter_magnetometer_residual_vector_data(struct microstrain_serializer* serializer, const mip_filter_magnetometer_residual_vector_data* self);
void extract_mip_filter_magnetometer_residual_vector_data(struct microstrain_serializer* serializer, mip_filter_magnetometer_residual_vector_data* self);
...
void insert_mip_filter_clock_correction_data(struct microstrain_serializer* serializer, const mip_filter_clock_correction_data* self);
void extract_mip_filter_clock_correction_data(struct microstrain_serializer* serializer, mip_filter_clock_correction_data* self);
...
void insert_mip_filter_clock_correction_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_clock_correction_uncertainty_data* self);
void extract_mip_filter_clock_correction_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_clock_correction_uncertainty_data* self);
...
void insert_mip_filter_gnss_pos_aid_status_data(struct microstrain_serializer* serializer, const mip_filter_gnss_pos_aid_status_data* self);
void extract_mip_filter_gnss_pos_aid_status_data(struct microstrain_serializer* serializer, mip_filter_gnss_pos_aid_status_data* self);
...
void insert_mip_filter_gnss_att_aid_status_data(struct microstrain_serializer* serializer, const mip_filter_gnss_att_aid_status_data* self);
void extract_mip_filter_gnss_att_aid_status_data(struct microstrain_serializer* serializer, mip_filter_gnss_att_aid_status_data* self);
...
void insert_mip_filter_head_aid_status_data(struct microstrain_serializer* serializer, const mip_filter_head_aid_status_data* self);
void extract_mip_filter_head_aid_status_data(struct microstrain_serializer* serializer, mip_filter_head_aid_status_data* self);
...
void insert_mip_filter_rel_pos_ned_data(struct microstrain_serializer* serializer, const mip_filter_rel_pos_ned_data* self);
void extract_mip_filter_rel_pos_ned_data(struct microstrain_serializer* serializer, mip_filter_rel_pos_ned_data* self);
...
void insert_mip_filter_ecef_pos_data(struct microstrain_serializer* serializer, const mip_filter_ecef_pos_data* self);
void extract_mip_filter_ecef_pos_data(struct microstrain_serializer* serializer, mip_filter_ecef_pos_data* self);
...
void insert_mip_filter_ecef_vel_data(struct microstrain_serializer* serializer, const mip_filter_ecef_vel_data* self);
void extract_mip_filter_ecef_vel_data(struct microstrain_serializer* serializer, mip_filter_ecef_vel_data* self);
...
void insert_mip_filter_ecef_vel_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_ecef_vel_uncertainty_data* self);
void extract_mip_filter_ecef_vel_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_ecef_vel_uncertainty_data* self);
...
void insert_mip_filter_aiding_measurement_summary_data(struct microstrain_serializer* serializer, const mip_filter_aiding_measurement_summary_data* self);
...
void insert_mip_filter_odometer_scale_factor_error_data(struct microstrain_serializer* serializer, const mip_filter_odometer_scale_factor_error_data* self);
void extract_mip_filter_odometer_scale_factor_error_data(struct microstrain_serializer* serializer, mip_filter_odometer_scale_factor_error_data* self);
...
void insert_mip_filter_odometer_scale_factor_error_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_odometer_scale_factor_error_uncertainty_data* self);
void extract_mip_filter_odometer_scale_factor_error_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_odometer_scale_factor_error_uncertainty_data* self);
...
void insert_mip_filter_gnss_dual_antenna_status_data(struct microstrain_serializer* serializer, const mip_filter_gnss_dual_antenna_status_data* self);
void extract_mip_filter_gnss_dual_antenna_status_data(struct microstrain_serializer* serializer, mip_filter_gnss_dual_antenna_status_data* self);
...
void insert_mip_filter_aiding_frame_config_error_data(struct microstrain_serializer* serializer, const mip_filter_aiding_frame_config_error_data* self);
void extract_mip_filter_aiding_frame_config_error_data(struct microstrain_serializer* serializer, mip_filter_aiding_frame_config_error_data* self);
...
void insert_mip_filter_aiding_frame_config_error_uncertainty_data(struct microstrain_serializer* serializer, const mip_filter_aiding_frame_config_error_uncertainty_data* self);
void extract_mip_filter_aiding_frame_config_error_uncertainty_data(struct microstrain_serializer* serializer, mip_filter_aiding_frame_config_error_uncertainty_data* self);
