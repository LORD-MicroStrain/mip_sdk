...
enum 
{
    ...
    MIP_CMD_DESC_AIDING_ECEF_POS           = 0x01,
    MIP_CMD_DESC_AIDING_LLH_POS            = 0x02,
    MIP_CMD_DESC_AIDING_LOCAL_POS          = 0x03,
    MIP_CMD_DESC_AIDING_HEIGHT_ABS         = 0x04,
    MIP_CMD_DESC_AIDING_HEIGHT_REL         = 0x05,
    MIP_CMD_DESC_AIDING_ECEF_VEL           = 0x08,
    MIP_CMD_DESC_AIDING_NED_VEL            = 0x09,
    MIP_CMD_DESC_AIDING_ODOM_VEL           = 0x0A,
    MIP_CMD_DESC_AIDING_WHEELSPEED         = 0x0B,
    MIP_CMD_DESC_AIDING_HEADING_TRUE       = 0x11,
    MIP_CMD_DESC_AIDING_DELTA_POSITION     = 0x18,
    MIP_CMD_DESC_AIDING_DELTA_ATTITUDE     = 0x19,
    MIP_CMD_DESC_AIDING_LOCAL_ANGULAR_RATE = 0x1A,
    MIP_CMD_DESC_AIDING_ECHO_CONTROL       = 0x6F,
    
    MIP_REPLY_DESC_AIDING_ECEF_POS         = 0x81,
    MIP_REPLY_DESC_AIDING_LLH_POS          = 0x82,
    MIP_REPLY_DESC_AIDING_ECEF_VEL         = 0x88,
    MIP_REPLY_DESC_AIDING_NED_VEL          = 0x89,
    MIP_REPLY_DESC_AIDING_ODOM_VEL         = 0x8A,
    MIP_REPLY_DESC_AIDING_HEADING_TRUE     = 0x91,
    MIP_REPLY_DESC_AIDING_ECHO_CONTROL     = 0xEF,
};
...
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_ecef_pos  (0x13,0x01) Ecef Pos [C]
...
struct mip_aiding_ecef_pos_response
{
    mip_time time; ///< Timestamp of the measurement.
    uint8_t sensor_id; ///< Sensor ID.
    double position[3]; ///< ECEF position [m].
...
typedef struct mip_aiding_ecef_pos_response mip_aiding_ecef_pos_response;
void insert_mip_aiding_ecef_pos_response(struct mip_serializer* serializer, const mip_aiding_ecef_pos_response* self);
void extract_mip_aiding_ecef_pos_response(struct mip_serializer* serializer, mip_aiding_ecef_pos_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_llh_pos  (0x13,0x02) Llh Pos [C]
...
struct mip_aiding_llh_pos_response
{
    mip_time time; ///< Timestamp of the measurement.
    uint8_t sensor_id; ///< Sensor ID.
    double latitude; ///< [deg]
...
typedef struct mip_aiding_llh_pos_response mip_aiding_llh_pos_response;
void insert_mip_aiding_llh_pos_response(struct mip_serializer* serializer, const mip_aiding_llh_pos_response* self);
void extract_mip_aiding_llh_pos_response(struct mip_serializer* serializer, mip_aiding_llh_pos_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_ecef_vel  (0x13,0x08) Ecef Vel [C]
...
struct mip_aiding_ecef_vel_response
{
    mip_time time; ///< Timestamp of the measurement.
    uint8_t sensor_id; ///< Sensor ID.
    float velocity[3]; ///< ECEF velocity [m/s].
...
typedef struct mip_aiding_ecef_vel_response mip_aiding_ecef_vel_response;
void insert_mip_aiding_ecef_vel_response(struct mip_serializer* serializer, const mip_aiding_ecef_vel_response* self);
void extract_mip_aiding_ecef_vel_response(struct mip_serializer* serializer, mip_aiding_ecef_vel_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_ned_vel  (0x13,0x09) Ned Vel [C]
...
struct mip_aiding_ned_vel_response
{
    mip_time time; ///< Timestamp of the measurement.
    uint8_t sensor_id; ///< Sensor ID.
    float velocity[3]; ///< NED velocity [m/s].
...
typedef struct mip_aiding_ned_vel_response mip_aiding_ned_vel_response;
void insert_mip_aiding_ned_vel_response(struct mip_serializer* serializer, const mip_aiding_ned_vel_response* self);
void extract_mip_aiding_ned_vel_response(struct mip_serializer* serializer, mip_aiding_ned_vel_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_vehicle_fixed_frame_velocity  (0x13,0x0A) Vehicle Fixed Frame Velocity [C]
...
struct mip_aiding_vehicle_fixed_frame_velocity_response
{
    mip_time time; ///< Timestamp of the measurement.
    uint8_t sensor_id; ///< Source ID for this estimate ( source_id == 0 indicates this sensor, source_id > 0 indicates an external estimate )
    float velocity[3]; ///< [m/s]
...
typedef struct mip_aiding_vehicle_fixed_frame_velocity_response mip_aiding_vehicle_fixed_frame_velocity_response;
void insert_mip_aiding_vehicle_fixed_frame_velocity_response(struct mip_serializer* serializer, const mip_aiding_vehicle_fixed_frame_velocity_response* self);
void extract_mip_aiding_vehicle_fixed_frame_velocity_response(struct mip_serializer* serializer, mip_aiding_vehicle_fixed_frame_velocity_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_true_heading  (0x13,0x11) True Heading [C]
///
///@{
...
struct mip_aiding_true_heading_response
{
    mip_time time;
    uint8_t sensor_id;
    float heading; ///< Heading in [radians]
...
typedef struct mip_aiding_true_heading_response mip_aiding_true_heading_response;
void insert_mip_aiding_true_heading_response(struct mip_serializer* serializer, const mip_aiding_true_heading_response* self);
void extract_mip_aiding_true_heading_response(struct mip_serializer* serializer, mip_aiding_true_heading_response* self);
...
///
////////////////////////////////////////////////////////////////////////////////
///@defgroup c_aiding_aiding_echo_control  (0x13,0x6F) Aiding Echo Control [C]
///
///@{
