...
void insert_mip_gnss_pos_llh_data(struct microstrain_serializer* serializer, const mip_gnss_pos_llh_data* self);
void extract_mip_gnss_pos_llh_data(struct microstrain_serializer* serializer, mip_gnss_pos_llh_data* self);
...
void insert_mip_gnss_pos_ecef_data(struct microstrain_serializer* serializer, const mip_gnss_pos_ecef_data* self);
void extract_mip_gnss_pos_ecef_data(struct microstrain_serializer* serializer, mip_gnss_pos_ecef_data* self);
...
void insert_mip_gnss_vel_ned_data(struct microstrain_serializer* serializer, const mip_gnss_vel_ned_data* self);
void extract_mip_gnss_vel_ned_data(struct microstrain_serializer* serializer, mip_gnss_vel_ned_data* self);
...
void insert_mip_gnss_vel_ecef_data(struct microstrain_serializer* serializer, const mip_gnss_vel_ecef_data* self);
void extract_mip_gnss_vel_ecef_data(struct microstrain_serializer* serializer, mip_gnss_vel_ecef_data* self);
...
void insert_mip_gnss_dop_data(struct microstrain_serializer* serializer, const mip_gnss_dop_data* self);
void extract_mip_gnss_dop_data(struct microstrain_serializer* serializer, mip_gnss_dop_data* self);
...
void insert_mip_gnss_utc_time_data(struct microstrain_serializer* serializer, const mip_gnss_utc_time_data* self);
...
void insert_mip_gnss_gps_time_data(struct microstrain_serializer* serializer, const mip_gnss_gps_time_data* self);
void extract_mip_gnss_gps_time_data(struct microstrain_serializer* serializer, mip_gnss_gps_time_data* self);
...
void insert_mip_gnss_clock_info_data(struct microstrain_serializer* serializer, const mip_gnss_clock_info_data* self);
void extract_mip_gnss_clock_info_data(struct microstrain_serializer* serializer, mip_gnss_clock_info_data* self);
...
void insert_mip_gnss_fix_info_data(struct microstrain_serializer* serializer, const mip_gnss_fix_info_data* self);
void extract_mip_gnss_fix_info_data(struct microstrain_serializer* serializer, mip_gnss_fix_info_data* self);
...
void insert_mip_gnss_sv_info_data(struct microstrain_serializer* serializer, const mip_gnss_sv_info_data* self);
void extract_mip_gnss_sv_info_data(struct microstrain_serializer* serializer, mip_gnss_sv_info_data* self);
...
void insert_mip_gnss_hw_status_data(struct microstrain_serializer* serializer, const mip_gnss_hw_status_data* self);
void extract_mip_gnss_hw_status_data(struct microstrain_serializer* serializer, mip_gnss_hw_status_data* self);
...
void insert_mip_gnss_dgps_info_data(struct microstrain_serializer* serializer, const mip_gnss_dgps_info_data* self);
void extract_mip_gnss_dgps_info_data(struct microstrain_serializer* serializer, mip_gnss_dgps_info_data* self);
...
void insert_mip_gnss_dgps_channel_data(struct microstrain_serializer* serializer, const mip_gnss_dgps_channel_data* self);
void extract_mip_gnss_dgps_channel_data(struct microstrain_serializer* serializer, mip_gnss_dgps_channel_data* self);
...
void insert_mip_gnss_clock_info_2_data(struct microstrain_serializer* serializer, const mip_gnss_clock_info_2_data* self);
void extract_mip_gnss_clock_info_2_data(struct microstrain_serializer* serializer, mip_gnss_clock_info_2_data* self);
...
void insert_mip_gnss_gps_leap_seconds_data(struct microstrain_serializer* serializer, const mip_gnss_gps_leap_seconds_data* self);
void extract_mip_gnss_gps_leap_seconds_data(struct microstrain_serializer* serializer, mip_gnss_gps_leap_seconds_data* self);
...
void insert_mip_gnss_sbas_info_data(struct microstrain_serializer* serializer, const mip_gnss_sbas_info_data* self);
void extract_mip_gnss_sbas_info_data(struct microstrain_serializer* serializer, mip_gnss_sbas_info_data* self);
...
void insert_mip_gnss_sbas_correction_data(struct microstrain_serializer* serializer, const mip_gnss_sbas_correction_data* self);
void extract_mip_gnss_sbas_correction_data(struct microstrain_serializer* serializer, mip_gnss_sbas_correction_data* self);
...
void insert_mip_gnss_rf_error_detection_data(struct microstrain_serializer* serializer, const mip_gnss_rf_error_detection_data* self);
void extract_mip_gnss_rf_error_detection_data(struct microstrain_serializer* serializer, mip_gnss_rf_error_detection_data* self);
...
void insert_mip_gnss_base_station_info_data(struct microstrain_serializer* serializer, const mip_gnss_base_station_info_data* self);
void extract_mip_gnss_base_station_info_data(struct microstrain_serializer* serializer, mip_gnss_base_station_info_data* self);
...
void insert_mip_gnss_rtk_corrections_status_data(struct microstrain_serializer* serializer, const mip_gnss_rtk_corrections_status_data* self);
void extract_mip_gnss_rtk_corrections_status_data(struct microstrain_serializer* serializer, mip_gnss_rtk_corrections_status_data* self);
...
void insert_mip_gnss_satellite_status_data(struct microstrain_serializer* serializer, const mip_gnss_satellite_status_data* self);
void extract_mip_gnss_satellite_status_data(struct microstrain_serializer* serializer, mip_gnss_satellite_status_data* self);
...
void insert_mip_gnss_raw_data(struct microstrain_serializer* serializer, const mip_gnss_raw_data* self);
void extract_mip_gnss_raw_data(struct microstrain_serializer* serializer, mip_gnss_raw_data* self);
...
void insert_mip_gnss_gps_ephemeris_data(struct microstrain_serializer* serializer, const mip_gnss_gps_ephemeris_data* self);
void extract_mip_gnss_gps_ephemeris_data(struct microstrain_serializer* serializer, mip_gnss_gps_ephemeris_data* self);
...
void insert_mip_gnss_galileo_ephemeris_data(struct microstrain_serializer* serializer, const mip_gnss_galileo_ephemeris_data* self);
void extract_mip_gnss_galileo_ephemeris_data(struct microstrain_serializer* serializer, mip_gnss_galileo_ephemeris_data* self);
...
void insert_mip_gnss_glo_ephemeris_data(struct microstrain_serializer* serializer, const mip_gnss_glo_ephemeris_data* self);
void extract_mip_gnss_glo_ephemeris_data(struct microstrain_serializer* serializer, mip_gnss_glo_ephemeris_data* self);
...
void insert_mip_gnss_gps_iono_corr_data(struct microstrain_serializer* serializer, const mip_gnss_gps_iono_corr_data* self);
void extract_mip_gnss_gps_iono_corr_data(struct microstrain_serializer* serializer, mip_gnss_gps_iono_corr_data* self);
...
void insert_mip_gnss_galileo_iono_corr_data(struct microstrain_serializer* serializer, const mip_gnss_galileo_iono_corr_data* self);
void extract_mip_gnss_galileo_iono_corr_data(struct microstrain_serializer* serializer, mip_gnss_galileo_iono_corr_data* self);
