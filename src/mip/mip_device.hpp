...
{
    setUpdateFunction([](C::mip_interface* device, C::mip_timeout wait_time, bool from_cmd){
...
void DeviceInterface::setUpdateFunction()
{
    ...
    setUpdateFunction(
        [](C::mip_interface* device, C::mip_timeout wait_time, bool from_cmd)->bool
        {
...
void DeviceInterface::setCallbacks(T* object)
{
    ...
    auto recv = [](C::mip_interface* device, C::mip_timeout wait_time, bool from_cmd, C::mip_timestamp* timestamp_out)
    {
        return (static_cast<T*>(mip_interface_user_pointer(device))->*Recv)(wait_time, from_cmd, timestamp_out);
    };
    auto update = [](C::mip_interface* device, C::mip_timeout wait_time, bool from_cmd)
    {
