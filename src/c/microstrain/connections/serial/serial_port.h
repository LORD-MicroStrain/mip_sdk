...
#include <microstrain/connections/connection_interface.h>
...
typedef struct serial_port
{
    ...
    microstrain_connection_data_interceptors data_interceptors;
} serial_port;
...
void serial_port_init(serial_port* _serial_port, const char* _port_name, const uint32_t _baudrate/*,
    microstrain_connection_data_interceptors* _data_interceptors*/);

void serial_port_set_interceptors(serial_port* _serial_port, microstrain_interceptor* _receive_interceptor, microstrain_interceptor* _send_interceptor);
