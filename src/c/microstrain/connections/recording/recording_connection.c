...
void recording_connection_init_receive_data_interceptor(recording_connection* _recording_connection,
    microstrain_interceptor* _receive_interceptor, microstrain_interceptor_handler* _receive_interceptor_handler)
{
    microstrain_interceptor_init(_receive_interceptor);

    microstrain_interceptor_handler_init_array_data_handler(_receive_interceptor_handler,
        recording_connection_intercept_received_bytes, _recording_connection);

    microstrain_interceptor_add_handler(_receive_interceptor, _receive_interceptor_handler);
}
...
void recording_connection_intercept_received_bytes(void* _receive_buffer, size_t _byte_count, void* _recording_connection)
{
    recording_connection_write_received_bytes((recording_connection*)_recording_connection, (uint8_t*)_receive_buffer, _byte_count, NULL);
}
...
void recording_connection_init_send_data_interceptor(recording_connection* _recording_connection,
    microstrain_interceptor* _send_interceptor, microstrain_interceptor_handler* _send_interceptor_handler)
{
    microstrain_interceptor_init(_send_interceptor);

    microstrain_interceptor_handler_init_array_data_handler(_send_interceptor_handler,
        recording_connection_intercept_sent_bytes, _recording_connection);

    microstrain_interceptor_add_handler(_send_interceptor, _send_interceptor_handler);
}
...
void recording_connection_intercept_sent_bytes(void* _send_buffer, size_t _byte_count, void* _recording_connection)
{
    recording_connection_write_sent_bytes((recording_connection*)_recording_connection, (uint8_t*)_send_buffer, _byte_count, NULL);
}
