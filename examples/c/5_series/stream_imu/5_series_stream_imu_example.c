...
/// @{
///
/// @defgroup _5_series_stream_imu_example_c 5-Series Stream IMU Example [C]
///
...
///
/// @section _5_series_stream_imu_example_c_license License
///
...
void configure_sensor_message_format(
