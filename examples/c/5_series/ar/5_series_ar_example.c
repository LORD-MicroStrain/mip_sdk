...
///
/// @section _5_series_ar_example_c_license License
///
...
////////////////////////////////////////////////////////////////////////////////
/// @addtogroup _5_series_ar_example_c
/// @{
///
...
static void initialize_filter(mip_interface* _device)
{
    ...
    mip_cmd_result cmd_result = mip_filter_write_auto_init_control(
        _device,
        1 // Enabled
    );
