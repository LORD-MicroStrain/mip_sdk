...
#if USE_THREADS
// Threaded functions
bool updateDevice(mip::Interface& _device, const mip::Timeout _waitTime, const bool _fromCommand);
...
///                   commands)
/// @param _fromCommand True if called from command handling, false for data
///                  collection
///
