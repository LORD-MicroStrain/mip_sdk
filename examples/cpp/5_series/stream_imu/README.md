...
This example demonstrates how to stream basic IMU sensor data from a MicroStrain 5-series device with the MIP SDK 
using the C++ API.

## Overview

The example showcases basic IMU sensor data streaming setup and operation of a 5-series device, including:
...
- C version: `5_series_stream_imu_example.c`
