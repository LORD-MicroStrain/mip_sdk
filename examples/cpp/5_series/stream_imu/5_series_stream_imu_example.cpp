...
int main(const int argc, const char* argv[])
{
    ...
    device.registerPacketCallback<packetCallback>(
        packetHandler,
        mip::Dispatcher::ANY_DATA_SET, // Data field descriptor
    ...
    device.registerFieldCallback<accelFieldCallback>(
        ...
        mip::data_sensor::ScaledAccel::FIELD_DESCRIPTOR, // Data field descriptor
        nullptr                                          // User data
    );
    ...
    device.registerFieldCallback<gyroFieldCallback>(
        ...
        mip::data_sensor::ScaledGyro::FIELD_DESCRIPTOR, // Data field descriptor
        nullptr                                         // User data
    );
    ...
    device.registerFieldCallback<magFieldCallback>(
        ...
        mip::data_sensor::ScaledMag::FIELD_DESCRIPTOR, // Data field descriptor
        nullptr                                        // User data
    );
    ...
    const uint8_t _supportedDescriptorCount)
{
    ...
    const uint16_t sensorDecimation  = sensorBaseRate / SAMPLE_RATE;
